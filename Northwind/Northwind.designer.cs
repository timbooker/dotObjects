...
using dotObjects.Core.Processing;
    ...
    partial void DeleteEmployee(Employee instance);
		...
		public NorthwindDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["dotObjects.Northwind"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		internal System.Data.Linq.Table<CustomerCustomerDemo> CustomerCustomerDemos
		{
			get
			{
		...
		internal System.Data.Linq.Table<CustomerDemographic> CustomerDemographics
		{
			get
			{
		...
		internal System.Data.Linq.Table<EmployeeTerritory> EmployeeTerritories
		{
			get
			{
    ...
    partial void OnPictureChanged();
		...
		internal System.Data.Linq.Binary Picture
		{
			get
			{
    ...
    partial void OnRegionIDChanged();
		...
		internal EntitySet<EmployeeTerritory> EmployeeTerritories
		{
			get
			{
	...
	internal partial class CustomerCustomerDemo : INotifyPropertyChanging, INotifyPropertyChanged
	{
	...
	internal partial class CustomerDemographic : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnCustomerDescChanged();
		...
		internal EntitySet<CustomerCustomerDemo> CustomerCustomerDemos
		{
			get
			{
	...
	internal partial class EmployeeTerritory : INotifyPropertyChanging, INotifyPropertyChanged
	{
	...
	public partial class Order : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<OrderItem> _Order_Details;
    ...
    partial void OnShipCountryChanged();
		...
		public Order()
		{
			this._Order_Details = new EntitySet<OrderItem>(new Action<OrderItem>(this.attach_Order_Details), new Action<OrderItem>(this.detach_Order_Details));
			this._Customer = default(EntityRef<Customer>);
		...
		internal System.Nullable<int> EmployeeID
		{
			get
			{
				return this._EmployeeID;
        ...
        [NonVisibleOn(ProcessBehavior.Search)]
		...
		internal System.Nullable<int> ShipVia
		{
			get
			{
        ...
        [NonVisibleOn(ProcessBehavior.Search)]
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Order_OrderItem", Storage="_Order_Details", ThisKey="OrderID", OtherKey="OrderID")]
		...
		private void attach_Order_Details(OrderItem entity)
		{
			this.SendPropertyChanging();
			entity.Order = this;
		}
		
		private void detach_Order_Details(OrderItem entity)
		{
			this.SendPropertyChanging();
			entity.Order = null;
		}
    ...
    partial void OnDiscontinuedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_OrderItem", Storage="_Order_Details", ThisKey="ProductID", OtherKey="ProductID")]
		internal EntitySet<OrderItem> OrderItems
		{
			get
			{
				return this._Order_Details;
	...
	public partial class Employee : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Employee> _ReportTo;
    ...
    partial void OnPasswordChanged();
		...
		public Employee()
		{
			...
			this._ReportTo = default(EntityRef<Employee>);
			OnCreated();
		}
		...
		internal System.Data.Linq.Binary Photo
		{
			get
			{
				return this._Photo;
		...
		internal System.Nullable<int> ReportsTo
		{
			get
			{
			...
			set
			{
				...
				{
					if (this._ReportTo.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_Employee", Storage="_ReportTo", ThisKey="ReportsTo", OtherKey="EmployeeID", IsForeignKey=true)]
		internal Employee Manager
		{
			get
			{
				return this._ReportTo.Entity;
			}
			set
			{
				Employee previousValue = this._ReportTo.Entity;
				if (((previousValue != value) 
							|| (this._ReportTo.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._ReportTo.Entity = null;
						previousValue.Employees.Remove(this);
					}
					this._ReportTo.Entity = value;
					if ((value != null))
					{
